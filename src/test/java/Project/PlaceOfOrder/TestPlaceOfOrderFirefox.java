...
import static Project.PageObject.LocatorsMainPage.*;
import static Project.PageObject.LocatorsFirstPageOrder.*;

@RunWith(Parameterized.class)
public class TestPlaceOfOrderFirefox {
